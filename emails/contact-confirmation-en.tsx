...
interface ContactConfirmationEmailEnProps {
  name: string;
  email: string;
  project: string;
...
export const ContactConfirmationEmailEn = ({
  name,
  email,
  project,
  messageSnippet,
}: ContactConfirmationEmailEnProps) => {
  return (
    <Html>
      <Head />
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={text}>
              I&apos;ll review your message carefully and get back to you within 24 hours. If your project is time-sensitive, feel free to reach out to me directly on <a href="https://linkedin.com/in/fernando-rm" style={link}>LinkedIn</a>.
            </Text>
