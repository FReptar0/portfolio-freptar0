...
- [x] **Phase 8: Case Study Accuracy** - Correct Spring Boot references, clarify CarryTrade status, show team roles, and audit cross-content consistency across all locale files (completed 2026-03-27)
