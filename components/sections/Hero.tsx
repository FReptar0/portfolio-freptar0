    ...
    <section className="relative min-h-[90vh] flex items-end overflow-hidden pb-24 pt-32">
      <div className="px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-end">
          {/* Left column -- typographic poster (immediately visible for LCP) */}
          ...
          {/* Right column -- metrics, status, CTAs (staggered entrance) */}
          <div className="lg:col-span-5 space-y-8">
            {/* Status badge */}
            <div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg animate-fade-in"
            ...
            >
              <a
                href="#projects"
                className="px-8 py-4 text-[var(--color-on-accent)] font-semibold rounded-lg transition-all duration-200 text-center hover:scale-[1.02] active:scale-[0.98]"
